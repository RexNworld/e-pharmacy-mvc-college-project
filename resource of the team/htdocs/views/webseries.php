...
<div class="container-fluid">
    <div class="btn-group" role="group"><a class="btn btn-primary" role="button" href="/add_webseries" style="background: #07689f; border-width: 4px;border-color: #e0e0e0;">Add Webseries</a></div>
</div>
<hr>
<section id="filmsSection">
    <div class="row g-0">
        
        <div class="col-6 col-lg-3 col-xl-3 col-xxl-2" style="padding: 6px;" id="video_{{item.id}}">
        <?php
            if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
            echo '<a href="/webseries_details?id='.$row['id'].'"><div class="container-fluid image-container" style="padding: 0;">';
